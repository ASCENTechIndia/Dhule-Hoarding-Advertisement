...
async function getIllegalHoardMonthwiseReport(req, res, next) {
  try {
    const {
      ulbId,
      year = null,
    ...
    const rows = await getIllegalHoardMonthwiseReportService(
      ulbId,
      year,
      monthNo,
      page,
    ...
    logApiSuccess(
      ...
      "Illegal Hoard Monthwise Report completed"
    );
    ...
    logApiError(
      ...
      500,
      error.message,
      "Illegal Hoard Monthwise Report search error"
    );
