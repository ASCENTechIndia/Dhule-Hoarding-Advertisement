    ...
    const getCurrentLocation = () => {
        return new Promise((resolve, reject) => {
            if (!navigator.geolocation) {
                reject(
                    new Error(
                        "आपल्या ब्राउझरमध्ये Location सुविधा उपलब्ध नाही."
                    )
                );
                return;
            }
...
const addGeoTagToImage = async ({
    ...
    const fontSize = Math.min(
        ...
        Math.max(
            12,
            Math.round(originalWidth * 0.015)
        )
    );
    ...
    const padding = Math.min(
        ...
        Math.max(
            10,
            Math.round(originalWidth * 0.025)
        )
    );
    ...
    const drawImageWithGeoTag = (
        ...
        const scaledGeoHeight =
            Math.round(
                geoSectionHeight * scale
            );
    ...
    alert(
        "फोटोचा आकार 10 MB पेक्षा कमी असावा."
    );
    ...
    return;
        ...
        try {
            ...
            if (
                ...
                alert(
                    "आपले location मिळू शकले नाही."
                );
            } else if (
                error?.code === 3
            ) {
                alert(
                    "Location मिळवण्यासाठी timeout झाला."
                );
            } else {
                alert(
                    "फोटो process करताना समस्या आली."
                );
            }
        } finally {
            setPhotoLoading((prev) => {
...
const clearForm = () => {
   ...
   const onSubmit = async (data) => {
    ...
    try {
        ...
        console.error(
            "Advertisement Panchnama Submit Error:",
            error
        );
...
<div className="row g-3 mb-4">
    ...
    {employeeFields.map((field, index) => (
        ...
        <div
            className="row g-2 person-row mb-2"
            key={field.id}
        >
        ...
        >
            ...
            <div className="col-md-8">
                ...
                <input
                    ...
                    {...register(
                        `advertisementDisplayedBy.${index}.name`,
                        {
                            required:
                                index === 0
                                    ? "नाव आवश्यक आहे"
